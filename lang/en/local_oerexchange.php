...
$string['privacy:metadata:local_oerexchange_sites'] = 'Client sites registered with this Exchange. The contact address identifies a person and is stored until the registration is removed; it is site-registration data entered by the remote site\'s administrator, not tied to a Moodle account here.';
